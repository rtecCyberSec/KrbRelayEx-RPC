        ...
        try
        {
            ...
            if (bytesRead > 0)
            {
                ...
                if (ticketOffset > 0 && !Program.forwdardmode )
                {
                    ...
                    ISystemActivatorOffset = 1; //Helpers.PatternAt(state.Buffer, new byte[] { 0x01, 0x00, 0x01, 0x00, 0xA0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 }); //ISystemActivatorUUID
                    IOXidResolverOffset = 1; //Helpers.PatternAt(state.Buffer, new byte[] { 0xC4, 0xFE, 0xFC, 0x99, 0x60, 0x52, 0x1B, 0x10, 0xBB, 0xCB, 0x00, 0xAA, 0x00, 0x21, 0x34, 0x7A, 0x00, 0x00, 0x00, 0x00 });
